  ...
  "cells": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "CE3bZNxTrUL9",
        "outputId": "5d0a6bb0-bc62-409e-a39c-646be0d1ade8"
      },
      "outputs": [
        {
          "output_type": "stream",
          "name": "stdout",
          "text": [
            "Enter an MLB pitchers name in the \"Lastname, Firstname\" format: deGrom, Jacob\n",
            "deGrom, Jacob Pitch Repertoire:\n",
            "Four Seam Fastball\n",
            "   Most similar pitches:\n",
            "     Loaisiga, Jonathan -- Similarity Score: 0.976\n",
            "     Hembree, Heath -- Similarity Score: 0.949\n",
            "     Bieber, Shane -- Similarity Score: 0.944\n",
            "Slider\n",
            "   Most similar pitches:\n",
            "     Cisnero, Jose -- Similarity Score: 0.961\n",
            "     Chacin, Jhoulys -- Similarity Score: 0.937\n",
            "     Garcia, Yimi -- Similarity Score: 0.935\n",
            "Curveball\n",
            "   Most similar pitches:\n",
            "     Diplan, Marcos -- Similarity Score: 0.963\n",
            "     Megill, Trevor -- Similarity Score: 0.95\n",
            "     Graveman, Kendall -- Similarity Score: 0.935\n",
            "Changeup\n",
            "   Most similar pitches:\n",
            "     Lopez, Jorge -- Similarity Score: 0.969\n",
            "     Diaz, Yennsy -- Similarity Score: 0.961\n",
            "     Lyles, Jordan -- Similarity Score: 0.955\n"
          ]
        }
      ],
      "source": [
